...
class AddExpenseView:
    ...
    def _add_expense_handler(self):
        ...
        if not description or not amount or not date:
            self._show_error("An expense must have description, amount and date!")
            return
    ...
    def _initialiaze_description(self):
        description_label = ttk.Label(master=self._frame, text="Expense Description")
        self._expense_description_entry = ttk.Entry(master=self._frame)
        description_label.grid(row=3, column=0, padx=5, pady=5, sticky=constants.W)
        self._expense_description_entry.grid(row=3, column=1,padx=5, pady=5, sticky=constants.EW)
    ...
    def _initialiaze_amount(self):
        ...
        self._expense_amount_entry.grid(row=4, column=1, padx=5, pady=5, sticky=constants.EW)
    ...
    def _initialiaze_date(self):
        ...
        self._expense_date_combobox = ttk.Combobox(master=self._frame, values=available_dates, state="readonly")
        self._expense_date_combobox.grid(row=5, column=1, padx=5, pady=5, sticky=constants.EW)
    ...
    def _initialize_budget(self):
        ...
        self._budget_entry.grid(row=1, column=1, padx=5, pady=5, sticky=constants.EW)
        ...
        set_budget_button.grid(row=2, column=0, columnspan=2, padx=5, pady=5, sticky=constants.EW)
    ...
    def _initialiaze(self):
        ...
        self._message_label = ttk.Label(master=self._frame, text="", foreground="blue")
        self._message_label.grid(row=0, column=0, columnspan=2,  padx=5, pady=5, sticky=constants.W)
        self._refresh_message()
        ...
        show_expenses_button.grid(row=7, column=0, padx=5, pady=5, sticky=constants.EW)
